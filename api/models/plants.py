class Plant:
    ...
    columns = ['id', 'institutionCode', 'collectionCode', 'ownerInstitutionCode',
               ...
               'otherCatalogNumbers', 'kingdom', 'phylum', 'class_', 'order_', 'family',
               ...
               'taxonRemarks', 'identificationQualifier', 'typeStatus', 'recordedBy',
               ...
               'establishmentMeans', 'lifeStage', 'sex', 'individualCount',
               'samplingProtocol', 'samplingEffort', 'preparations', 'country',
               'stateProvince', 'county', 'municipality', 'locality', 'locationRemarks',
